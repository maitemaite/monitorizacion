...
var agente1 = 0;
var agente2 = new agent;
		console.log = ('Enviar mensaje a consola');
		console.log = ('Enviar mensaje a recolector');	
		if (this.agente1.lenght > 20 ) {
			else console.log ('e-mail:agenterecolector' };
