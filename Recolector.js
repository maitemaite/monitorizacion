...
var JSON = parsetint('JSON');{
	if ( datos = 'nuevos datos' = parseint.json);
		else console.log ('ENVIAR MENSAJE A CONSOLA');
	}
	if tiempoCPUsegundoActual < tiempoCPU 
		else console.log ('e-mail');
